...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      { h: 'สิทธิ์ลง Quest ตอนเข้าห้อง', p: 'ห้องที่เป็น Investigation / Tempered — ต้องผ่าน Assigned Quest ของมอนสเตอร์ตัวนั้นก่อน ไม่งั้นเข้าร่วมไม่ได้\nถ้า Attempt ของเราครบแล้ว จะเข้าได้เฉพาะห้องที่ Host ก็ลงครบเหมือนกัน (ห้องที่ติดป้าย "HQ บังคับ") และรอบนั้นจะไม่นับ Attempt เพิ่มให้\nAssigned Quest เข้าร่วมได้เสมอ แม้จะผ่านมาแล้ว เพื่อไปช่วยผู้เล่นใหม่ (รอบนั้นไม่หัก Attempt ให้เรา)\nบนการ์ดห้องมีป้าย 📜 บอกสิทธิ์ที่เหลือของเราเอง และการกลับเข้าห้องเดิม (Reconnect) ไม่ติดเงื่อนไขเหล่านี้' },
      { h: 'การนับ Attempt ใน Co-op', p: 'ต่างคนต่างนับจากเซฟของตัวเอง ไม่ได้ใช้ของ Host\nชนะ = หัก 1 / แพ้ = หัก 1 ยกเว้น Assigned Quest ที่แพ้แล้วไม่หัก\nใครที่ Attempt ครบแล้วจะไม่ถูกหักเกินโควตา' },
